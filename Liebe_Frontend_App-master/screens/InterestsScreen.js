...
import { useRegisterContext } from "../context/RegisterContext"; // [AÑADIDO]

const InterestsScreen = () => {
  const navigation = useNavigation();
  const { registerData, setRegisterData } = useRegisterContext(); // [AÑADIDO]
  ...
  // [MODIFICADO] Función para actualizar el contexto con los intereses seleccionados y navegar a la siguiente pantalla
  const handleContinue = () => {
    setRegisterData({ ...registerData, interests: selectedInterests });
