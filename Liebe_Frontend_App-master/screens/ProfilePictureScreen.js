...
const styles = StyleSheet.create({
  ...
  cropContainer: {
    width: 300,
    height: 300,
    borderRadius: 20,  // Cambiado de 150 a 20 para bordes cuadrados redondeados
    overflow: "hidden",
    borderWidth: 3,    // Añadido borde
    borderColor: '#E82561', // Color del borde
    backgroundColor: "#ccc", // Cambiado a gris para coincidir
    marginBottom: 20,
  },
  croppableImage: {
    width: '100%',     // Cambiado a porcentaje para adaptarse
    height: '100%',
  },
